...
file_exists(FCPATH . 'uploads/' . $dataLama['file_bukti'])
                    ) {
@unlink(FCPATH . 'uploads/' . $dataLama['file_bukti']);
                    }
...
if (!empty($fileBukti) && file_exists(FCPATH . 'uploads/' . $fileBukti)) {
@unlink(FCPATH . 'uploads/' . $fileBukti);
            }
